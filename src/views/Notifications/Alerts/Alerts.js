      ...
      <div className="animated fadeIn">
        <Row>
          ...
          <Col xs="12" md="6">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"/><strong>Alerts</strong><small> use <code>.alert-link</code> to provide links</small>
              </CardHeader>
              <CardBody>
                <Alert color="primary">
        ...
        <Row>
          <Col xs="12" md="6">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"/><strong>Alerts</strong> <small>additional content</small>
              </CardHeader>
              <CardBody>
                <Alert color="success">
          ...
          <Col xs="12" md="6">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"/><strong>Alerts</strong> <small>dismissing</small>
              </CardHeader>
              <CardBody>
